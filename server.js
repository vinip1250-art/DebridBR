...
// ============================================================
// NOTA: Copiei exatamente o conteúdo que você enviou nos anexos
...
const AIO_TEMPLATE_JSON = {
  ...
  "config": AIO_CONFIG_JSON, // Reutilizamos a config acima, já que o template inclui a config
  "formatter": {
    "id": "custom",
    "definition": {
  ...
  "sortCriteria": {
    ...
    "movies": [], "series": [], "anime": [], "cached": [], "cachedMovies": []
  },
  "deduplicator": {
    "enabled": true,
  ...
  "proxy": { "id": "mediaflow", "proxiedAddons": [ "f1b" ], "proxiedServices": [] },
  "trusted": false,
  "addonName": "AIO",
  ...
  "excludeSeederRange": [ 0, 1000 ],
  "requiredSeederRange": [ 1, 1000 ],
  ...
  "size": {
    "global": {
      "movies": [ 0, 100000000000 ],
      "series": [ 0, 100000000000 ]
    }
  },
  "hideErrors": true,
